...
SAVE_PATTERN = "/home/wanghao/Desktop/projects/WaymoVisualize/catkin_ws/src/waymo_pub/src/zhanghao_mota/demo/tk_ekf/seq_%s_frame_%d.txt"
...
if  __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        box3d_preds[:,:7] = kitti2waymo(box3d_preds[:,:7]) # actually, waymo to kitti coord ! 
